...
fragment.methods = [
    ...
    vertex.methods[2],
    [
        `float matrix_cross_product (vec2 p1, vec2 p2, vec2 p3) {`,
    ...
    [
        ...
        `    float d1 = matrix_cross_product(rotate_related_FragCoord, flip_vertexAlpha, flip_vertexBeta);`,
        `    float d2 = matrix_cross_product(rotate_related_FragCoord, flip_vertexBeta, flip_vertexGamma);`,
        `    float d3 = matrix_cross_product(rotate_related_FragCoord, flip_vertexGamma, flip_vertexAlpha);`,
