...
/*!**********************!*\
  !*** ./src/index.ts ***!
  \**********************/
/*! no static exports found */function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.NetV=void 0;const n=r(/*! ./utils/map2 */"./src/utils/map2.ts"),a=r(/*! ./node */"./src/node.ts"),i=r(/*! ./link */"./src/link.ts"),o=r(/*! ./configs */"./src/configs.ts"),s=r(/*! ./dataset */"./src/dataset/index.ts"),u=r(/*! ./renderer */"./src/renderer/index.ts"),l=r(/*! ./interaction/interaction */"./src/interaction/interaction.ts"),c=r(/*! ./utils/utils */"./src/utils/utils.ts"),g=r(/*! ./label/label */"./src/label/label.ts");t.NetV=class{constructor(e){if(this.Utils=c,this.$_id2node=new Map,this.$_ends2link=new n.default,this.$_sourceId2links=new Map,this.$_targetId2links=new Map,this.$_configs=JSON.parse(JSON.stringify(o)),this.$_lazyUpdate=!1,this.$_data={nodes:[],links:[]},this.$_modifiedLinkCount=0,!("container"in e)||"DIV"!==e.container.tagName)throw Error("Container should be specified as a div element!");this.$_container=e.container;for(const t in e)"container"!==t&&(e[t]===Object(e[t])?this.$_configs[t]=Object.assign(Object.assign({},this.$_configs[t]),e[t]):this.$_configs[t]=e[t]);const t=document.createElement("canvas"),r=window.devicePixelRatio||1;t.style.width=this.$_configs.width+"px",t.style.height=this.$_configs.height+"px",t.setAttribute("width",String(this.$_configs.width*r)),t.setAttribute("height",String(this.$_configs.height*r)),this.$_container.appendChild(t),this.$_renderer=new u.Renderer({canvas:t,width:this.$_configs.width,height:this.$_configs.height,backgroundColor:this.$_configs.backgroundColor,nodeLimit:this.$_configs.nodeLimit,linkLimit:this.$_configs.linkLimit}),this.labelManager=new g.LabelManager(this),this.$_interaction=new l.InteractionManager(this),this.$_configs.enablePanZoom&&this.$_interaction.initZoom(),this.$_interaction.initMouse()}backgroundColor(e){return e&&(this.$_configs.backgroundColor=e,this.$_renderer.setBackgroundColor(e)),this.$_configs.backgroundColor}$_addModifiedLinkCount(e){this.$_modifiedLinkCount+=e,this.$_modifiedLinkCount>this.$_configs.lazyUpdateThreshold&&(this.$_lazyUpdate=!0)}data(e){if(void 0===e)return this.$_data;this.$_data=Object.assign(Object.assign({},this.$_data),e),this.$_id2node=new Map,this.$_ends2link=new n.default,this.$_sourceId2links=new Map,this.$_targetId2links=new Map,this.$_renderer.clearData(),this.addNodes(this.$_data.nodes),this.addLinks(this.$_data.links)}addNode(e){return this.addNodes([e])[0]}addLink(e){return this.addLinks([e])[0]}addNodes(e){const t=e.map(e=>{e.id=e.id.toString();return new a.default(this,e)});return this.$_renderer.addNodes(t),t}addLinks(e){const t=e.map(e=>{e.source=e.source.toString(),e.target=e.target.toString();return new i.default(this,e)});return this.$_renderer.addLinks([...this.$_ends2link.values()]),t}getNodeById(e){return this.$_id2node.get(e)}getLinkByEnds(e,t){return this.$_ends2link.get([e,t])}nodes(){return[...this.$_id2node.values()]}links(){return[...this.$_ends2link.values()]}wipe(){this.$_data=void 0,this.$_id2node=new Map,this.$_ends2link=new n.default,this.$_sourceId2links=new Map,this.$_targetId2links=new Map,this.$_renderer.clearData()}loadDataset(e){return e in s?s[e]:(console.error("NetV does not have build-in dataset: "+e),{nodes:[],links:[]})}getElementByPosition(e){const t=this.$_renderer.getIdByPosition(e);if(t){if("string"==typeof t){return{type:"node",element:this.getNodeById(t)}}if(Array.isArray(t)){return{type:"link",element:this.getLinkByEnds(t[0],t[1])}}}}draw(){this.$_lazyUpdate&&(this.$_renderer.nodeManager.refreshPosition([...this.$_id2node.values()]),this.$_renderer.linkManager.refreshPosition([...this.$_ends2link.values()]),this.$_lazyUpdate=!1,this.$_modifiedLinkCount=0),this.$_renderer.draw()}centerOn(e){const t=e.position();this.$_interaction.centerPosition(t)}panBy(e,t){this.$_interaction.panBy(e,t),this.draw()}zoomBy(e,t){this.$_interaction.zoomBy(e,t),this.draw()}}},"./src/interaction/interaction.ts":
/*!****************************************!*\
  !*** ./src/interaction/interaction.ts ***!
  \****************************************/
/*! no static exports found */function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.InteractionManager=void 0;t.InteractionManager=class{constructor(e){this.transform={x:0,y:0,k:1},this.isMouseDown=!1,this.isMouseMove=!1,this.netv=e}panBy(e,t){this.transform.x+=e,this.transform.y+=t,this.netv.$_renderer.setTransform(this.transform),this.netv.labelManager.setTransform(this.transform)}zoomBy(e,t){let r=t;r||(r={x:this.netv.$_configs.width/2,y:this.netv.$_configs.height/2});const{x:n,y:a}=r;this.transform.x=(1-e)*n+e*this.transform.x,this.transform.y=(1-e)*a+e*this.transform.y,this.transform.k*=e,this.netv.$_renderer.setTransform(this.transform),this.netv.labelManager.setTransform(this.transform)}centerPosition(e){const t=e.x*this.transform.k+this.transform.x,r=e.y*this.transform.k+this.transform.y,n=this.netv.$_configs.width/2,a=this.netv.$_configs.height/2,i=n-t,o=a-r,s=this.transform.x,u=this.transform.y,l=e=>e*e;let c=1;const g=setInterval(()=>{this.transform.x=s+i*l(c/20),this.transform.y=u+o*l(c/20),this.netv.$_renderer.setTransform(this.transform),this.netv.labelManager.setTransform(this.transform),this.netv.draw(),c+=1,c>20&&clearInterval(g)},25)}initZoom(){const e=this.netv.$_container.querySelector("canvas"),t=t=>{const r=t.offsetX||t.pageX-e.offsetLeft,n=t.offsetY||t.pageY-e.offsetTop,a=t.deltaY?t.deltaY/40:t.detail?-t.detail:0;if(a){const e=Math.pow(1.1,a);this.transform.x=(1-e)*r+e*this.transform.x,this.transform.y=(1-e)*n+e*this.transform.y,this.transform.k*=e,this.netv.$_renderer.setTransform(this.transform),this.netv.labelManager.setTransform(this.transform),this.netv.draw()}t.preventDefault()};e.addEventListener("DOMMouseScroll",t,!1),e.addEventListener("mousewheel",t,!1)}initMouse(){const e=this.netv.$_container.querySelector("canvas");e.addEventListener("mousedown",t=>{var r;const n=t.offsetX||t.pageX-e.offsetLeft,a=t.offsetY||t.pageY-e.offsetTop,i=this.netv.$_configs.height-a;this.isMouseDown=!0,this.mouseDownPos={x:n,y:a},this.dragStartTransform=JSON.parse(JSON.stringify(this.transform)),this.mouseDownElement=this.netv.getElementByPosition({x:n,y:i}),(null===(r=this.mouseDownElement)||void 0===r?void 0:r.element.position)&&(this.mouseDownElementOriginPos=Object.assign({},this.mouseDownElement.element.position()))}),e.addEventListener("mousemove",t=>{const r=t.offsetX||t.pageX-e.offsetLeft,n=t.offsetY||t.pageY-e.offsetTop;if(this.isMouseDown)this.isMouseMove=!0,this.mouseDownElement&&this.mouseDownElement.element.position?(this.mouseDownElement.element.position({x:this.mouseDownElementOriginPos.x+(r-this.mouseDownPos.x)/this.transform.k,y:this.mouseDownElementOriginPos.y+(n-this.mouseDownPos.y)/this.transform.k}),this.netv.draw(),this.mouseDownElement.element.showLabel(!1),this.mouseDownElement.element.showLabel(!0)):(this.transform.x=this.dragStartTransform.x+r-this.mouseDownPos.x,this.transform.y=this.dragStartTransform.y+n-this.mouseDownPos.y,this.netv.$_renderer.setTransform(this.transform),this.netv.labelManager.setTransform(this.transform),this.netv.draw());else{const e=this.netv.$_configs.height-n,t=this.netv.getElementByPosition({x:r,y:e});(null==t?void 0:t.element.$_hoverCallback)&&t.element.$_hoverCallback(t.element)}}),e.addEventListener("mouseup",e=>{var t;!this.isMouseMove&&this.mouseDownElement&&(null===(t=this.mouseDownElement)||void 0===t?void 0:t.element.$_clickCallback)&&this.mouseDownElement.element.$_clickCallback(this.mouseDownElement.element),this.isMouseDown=!1,this.isMouseMove=!1,this.mouseDownElement=void 0})}}},"./src/label/label.ts":
/*!****************************!*\
  !*** ./src/label/label.ts ***!
  \****************************/
