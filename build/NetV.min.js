...
/*!************************!*\
  !*** ./src/configs.ts ***!
  \************************/
/*! no static exports found */function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.label=t.link=t.node=t.maxLazyUpdateElementCount=t.linkLimit=t.nodeLimit=t.enablePanZoom=t.backgroundColor=t.height=t.width=void 0,t.width=800,t.height=600,t.backgroundColor={r:1,g:1,b:1,a:1},t.enablePanZoom=!0,t.nodeLimit=100,t.linkLimit=1e3,t.maxLazyUpdateElementCount=10,t.node={style:{shape:"circle",offset:{x:0,y:0},fill:{r:.2,g:.6,b:.2,a:.8},strokeColor:{r:.9,g:.9,b:.9,a:.6},strokeWidth:2,r:5,width:5,height:5,rotate:0,vertexAlpha:{x:0,y:-4},vertexBeta:{x:-2*Math.sqrt(3),y:2},vertexGamma:{x:2*Math.sqrt(3),y:2}},showLabel:!1,clickCallback:e=>{},hoverCallback:e=>{}},t.link={style:{shape:"line",strokeColor:{r:.4,g:.6,b:.8,a:.5},strokeWidth:2},clickCallback:e=>{},hoverCallback:e=>{}},t.label={offset:{x:8,y:0},fontSize:18,strokeWidth:.5}},"./src/dataset/index.ts":
/*!******************************!*\
...
/*!*********************************!*\
  ...
  \*********************************/
/*! no static exports found */function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const n=r(/*! ../utils/utils */"./src/utils/utils.ts");t.default=class{constructor(e,t){this.$_style={};const r=this.constructor.name.toLowerCase();this.$_core=e;const a=this.$_core.$_configs;this.$_style=n.override(a[r].style,t.style);const i=this.$_core.$_renderer[r+"Manager"];this.$_changeRenderAttribute=i.changeAttribute.bind(i),this.onClick((null==t?void 0:t.clickCallback)||a[r].clickCallback),this.onHover((null==t?void 0:t.hoverCallback)||a[r].hoverCallback),Object.keys(this.$_style).forEach(e=>{this[e]=this.generateElementStyleGetterSetter(e)})}onHover(e){this.$_hoverCallback=e}onClick(e){this.$_clickCallback=e}generateElementStyleGetterSetter(e){return t=>(void 0!==t&&(t===Object(t)?this.$_style[e]=n.override(this.$_style[e],t):this.$_style[e]=t,this.$_changeRenderAttribute(this,e)),this.$_style[e])}}},"./src/elements/link.ts":
/*!******************************!*\
