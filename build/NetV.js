...
class InteractionManager {
    ...
    changeMouseEventCallbackCountBy(n) {
    ...
    handleMouseMove(evt) {
        ...
        if (this.isMouseDown) {
            ...
            if (element === null || element === void 0 ? void 0 : element.element.$_hoverCallbackSet.size) {
                element.element.$_hoverCallbackSet.forEach((callback) => callback({
                    event: evt,
                    name: 'hover',
                    element
                }));
    ...
    handleMouseUp(evt) {
        ...
        if (!this.isMouseMove && this.mouseDownElement) {
            // click
            if ((_a = this.mouseDownElement) === null || _a === void 0 ? void 0 : _a.element.$_clickCallbackSet) {
