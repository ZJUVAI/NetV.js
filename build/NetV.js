...
class Node {
    ...
    neighborNodes() {
        ...
        (_a = this.$_core.$_sourceId2links.get(this.$_id)) === null || _a === void 0 ? void 0 : _a.forEach((link) => {
            nodeSet.add(link.$_target);
        });
        (_b = this.$_core.$_targetId2links.get(this.$_id)) === null || _b === void 0 ? void 0 : _b.forEach((link) => {
