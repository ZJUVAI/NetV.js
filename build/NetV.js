...
class RenderNodeManager extends render_element_1.RenderElementManager {
    ...
    refreshPosition(nodes) {
        ...
        this.gl.bufferSubData(this.gl.ARRAY_BUFFER, 0, posAttr.array, 0, posAttr.size * nodes.length);
    }
}
