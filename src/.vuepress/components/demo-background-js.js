...
export default function demo(id) {
    ...
    window.onload = function () {
        ...
        div.style = `text-align: center; height: ${height}px;`
        ...
        image.onload = function () {
            ...
            let style = `max-width: ${image.width}px; max-height: ${image.height}px;width: ${
                height * ratio
            }px;height: ${height}px; transform: translate(-50%, -50%); position: absolute; left: 50%; top: 50%;`
